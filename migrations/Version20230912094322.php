 ...
 */
final class Version20230912094322 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT DEFAULT NULL, avis_id INT NOT NULL, titre VARCHAR(100) NOT NULL, contenu VARCHAR(255) NOT NULL, INDEX IDX_23A0E66FB88E14F (utilisateur_id), INDEX IDX_23A0E66197E709F (avis_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
